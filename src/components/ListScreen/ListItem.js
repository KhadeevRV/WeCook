...
import { StyleSheet, Text, View,SafeAreaView, ImageBackground, Dimensions,TouchableOpacity, Image, Platform } from 'react-native'
...
const ListItem = observer(({recept,onPress,eyeHandler}) => {
    ...
    const eyeBtn = [
        ...
        <TouchableOpacity style={{width:36,height:36,borderRadius:18,
            ...
            backgroundColor:openedEye ? Colors.yellow : Platform.select({ ios: null, android: '#E5E5E5' }),
            overflow:'hidden'}} activeOpacity={1}
            onPress={() => {
            ...
            /> : null}
            <Image source={openedEye ? require('../../../assets/icons/openedEye.png') : require('../../../assets/icons/closedEye.png')} 
...
const styles = StyleSheet.create({
    ...
    linearView:{
        position:'absolute',bottom:0,zIndex:100,width:'100%',
